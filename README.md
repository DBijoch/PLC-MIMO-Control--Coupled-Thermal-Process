...
Zrezygnowano z gotowych bloków funkcyjnych producenta na rzecz własnego kodu ST, co pozwoliło na głęboką analizę działania algorytmów. Obliczenia osadzono w przerwaniu czasowym (Fixed Scan = 4s), co zapewniło ścisły determinizm czasowy.
